...
- [如何安装不在PyPI/Conda上但在GitHub上可用的包](/knowledge-base/dependencies/install-package-not-pypi-conda-available-github)
- [在Streamlit Community Cloud上安装Snowflake Connector for Python](/knowledge-base/dependencies/snowflake-connector-python-streamlit-cloud)